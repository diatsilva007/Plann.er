    ...
    {isGuestsModalOpen && (
      ...
      {isConfirmTripModalOpen && (
        ...
        <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
          ...
          <p className='text-sm text-zinc-400'>
            Para concluir a criação da viagem para <span className='font-semibold text-zinc-100'> Florianópolis, Brasil </span> nas datas de <span className='font-semibold text-zinc-100'>16 a 27 de agosto de 2024</span> preecha seus dados abaixo:
          </p>  
          </div>
